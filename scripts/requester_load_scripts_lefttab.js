 ...
 */
(function ($) {
    $.fn.requester_load_scripts_lefttab = function () {
                 ...
                 setTimeout(function () {
                  ...
                  if (option.url != undefined
                      ...
                      $.ajax({
                         ...
                         && option.url.indexOf("ajax/timeline_viewsubitem.php") > 0 ) {
                      $.ajax({
                           url: url + 'ajax/loadscripts.php',
                           type: "POST",
                           dataType: "html",
...
$(document).requester_load_scripts_lefttab();
