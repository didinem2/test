...
xgettext *.php */*.php --copyright-holder='Requester Development Team' --package-name='GLPI - Requester plugin' --package-version='1.0.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
